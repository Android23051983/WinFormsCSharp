...
namespace Refill
{
    public partial class Form1 : Form
    {
        ...
        {
            vTimer.Stop();
            DialogResult result = MessageBox.Show("Ãîòîâû ðàáîòàòü ñ íîâûì êëèåíòîì?", "Íîâûé êëèåíò", MessageBoxButtons.YesNoCancel);
            switch (result)
            {
        ...
        {
            MessageBox.Show(tempTotalDay.ToString() + " ðóá.\nÎòìåí çà ñìåíó " +cancel+"\nÇà âû÷åòîì îòìåí çà ñìåíó çàðàáîòàíî "+totalDay, "Çàðàáîòîê çà òåêóùèé äåíü");
        }
